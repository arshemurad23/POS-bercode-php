...
if($password == $confirm_password){
    ...
    $qur = "insert into user_tbl values (null,'$username' ,'$email' , '$img' , '$password' , '$confirm_password' , 'user' )";
    $res = mysqli_query($con, $qur);

    if($res == true){

        $sel_qur = "SELECT * FROM user_tbl WHERE user_name = '$username' and user_password = '$password'";
...
<body class="register-page bg-body-secondary">
    <div class="register-box">
        ...
        if($alert_cpassword){
            echo "please check password & confirm-password is not match"; 
        }  
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3"> <input type="text" class="form-control" name="name" placeholder="User Name">
                    ...
                    <div class="input-group mb-3"> <input type="file" class="form-control" name="img" placeholder="Select image ">
                        <div class="input-group-text"> <span class="bi bi-person"></span> </div>
                    </div>
                    ...
                    <div class="input-group mb-3"> <input type="password" class="form-control" name="cpassword" placeholder="Confirm Password">
                        <div class="input-group-text"> <span class="bi bi-lock-fill"></span> </div>
                    </div> <!--begin::Row-->
             ...
             <p class="mb-0 mt-3"> <a href="../index.php" class="text-center">
