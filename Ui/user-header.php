            ...
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> 
                        ...
                        <img  src="assets/img/<?php echo $_SESSION['user_img'] ;?>"class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">
                            
                            <?php 
                        echo $_SESSION['user-username'] ?></span> </a>
                        <ul  class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary">
                                
                            <img src="assets/img/<?php echo $_SESSION['user_img'] ;?>" class="rounded-circle shadow" alt="User Image">
                ...
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon fas fa-table"></i>
                            ...
                            <li class="nav-item"> <a href="#" class="nav-link"><i class="nav-icon fas fa-list"></i>
                                <p>OrderLidt</p>
                            </a> </li>
                            ...
                            <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon fas fa-calculator"></i>
                                <p>Tex</p>
                            </a> </li>
                            ...
                            <li class="nav-item"> <a href="change_password.php" class="nav-link"> <i class="nav-icon fas fa-user-lock"></i>
                                <p>Change Passwor</p>
                            </a> </li>
