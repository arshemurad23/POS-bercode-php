...
if (isset($_POST['login'])) {
    ...
    if ($username != "" && $password != "") {
        ...
        // Query the database
        $qur = "SELECT * FROM user_tbl WHERE user_name = '$username' and user_password = '$password'";
        ...
        if ($res && mysqli_num_rows($res) > 0) {
            ...
            if ($row['user_name'] == $username && $row['user_password'] == $password) {
                ...
                if($row['role'] == "admin")
                {
                    ...
                    $_SESSION['admin-username'] = $row['user_name'];
                    $_SESSION['admin-user_email'] = $row['user_email'];
                    $_SESSION['admin-img'] = $row['img'];
...
if($alret_put){
    ...
    echo "pelase enter username and password ";
}
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="" method="post">
                    <div class="input-group mb-3"> <input type="text" name="username" class="form-control" placeholder="Enter username">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2"> <button type="submit" name="login" class="btn btn-primary">Login</button> </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
<br>              
                <p class="mb-0"> <a href="UI/register.php" class="text-center">
